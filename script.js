...
function advanceToNextStep() {
    ...
    steps[currentIndex].classList.add(`${DOM.timelineStepActive}`);
    slides[currentIndex].classList.add(`${DOM.timelineSlideActive}`);
  
    recalcStepActiveMarkerProps();
    setSlideContainerHeight(slides[currentIndex].clientHeight);
  }

// Start the automatic slider
setInterval(advanceToNextStep, 4000); // Change the interval as needed (in milliseconds)
